...
Original file is located at
    https://colab.research.google.com/drive/1zDpAzM48gqOQSP0LXK2U05y7ApfMuyZP
"""
...
#0. CRIM 마을별 1인당 범죄율
#1. ZN  주거용 토지 비율
#2. INDUS 도시당 소매점을 제외한 비지니스 비율(회사비율)
#3. CHAS 강을 경계하는 경우 1, 않은 경우 0
#4. NOX 일산화질소 농도(1천만분의 1)-공기질
#5. RM 평균 방 수
#6. AGE 주택의 나이
#7. DIS 보스톤 고용 센터 5곳까지의 거리-일자리지원여부
#8. RAD 고속도로 접근성
#9. TAX 재산세율
#10. PTRATIO 학생-교사비율
#11. B 마을별 흑인 비율
#12. LSTAT 낮은 인구 밀도
#13. MEDV 정답(단위 10,000달러)
