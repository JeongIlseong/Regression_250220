...
Original file is located at
    https://colab.research.google.com/drive/14y8_gQhkaCJNoFk6ykpHRpJfrtG4FAx2
"""
...
# y 데이터 - 라벨 - 타겟변수 - 종속변수
y = np.array([50,70,65,75,80,90,95,100])
# xdata는 공부시간, ydata 성적
# 공부시간에 따른 성적 분석
# 임의 공부시간을 입력하여 취득할 수 있는 성적 점수를 예측
print(x.shape)
print(y.shape)
...
# 예측데이터 생성
x_pred = np.array([[14],[18]]) # 공부시간이 14시간, 18시간일 때 성적 예측
x_normal_pred = (x_pred-x_mean)/x_std
print(x_normal_pred)
